...
export class Printer {
    ...
    startCFSPrint(filename: string, calibration: boolean = false) {
        filename = filename.replace(".gcode", "");
        this.set(Requests.startCFSPrint(filename, calibration));
    }

    startPrint(filename: string, calibration: boolean = false) {
        // WARNING
        ...
        filename = filename.replace(".gcode", "");
        this.set(Requests.startPrint(filename, calibration));
    }
